        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-row justify-between">
                <div class="flex flex-row gap-2">
                    ...
                    <input wire:model.live.debounce.200ms="searchKeyword" type="text" class="border border-slate-300 focus:border-blue-400 focus:outline-none py-2 px-3 rounded-md shadow-sm text-sm">
                </div>
                <div class="flex flex-row justify-end">
                    <a href="{{ route('post.form',0) }}" wire:navigate class="inline-flex items-center bg-blue-500 hover:bg-blue-400 text-white delay-50 duration-300 ease-in-out rounded-md px-4 py-2 text-sm font-medium">
            ...
            <div class="w-full mx-auto">
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-slate-800 text-sm">
                        <tr>
                        ...
                        <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                            <td class="px-4 py-2 text-sm text-gray-600">{{ $post->title }}</td>
                            <td class="px-4 py-2 text-sm text-gray-600">{{ ($post->created_at)->format('d/m/Y, H:i') }}</td>
                            <td class="h-px w-px whitespace-nowrap px-4 py-2">
